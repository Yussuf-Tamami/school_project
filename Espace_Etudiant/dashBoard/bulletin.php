...
$pdf->Cell(0, 6, utf8_decode("Ministère de l'Enseignement Superieur"), 0, 1, 'C');
...
$pdf->Cell(70, 8, "Matiere", 1);
$pdf->Cell(40, 8, "Moyenne", 1);
$pdf->Cell(60, 8, "Mention", 1);
$pdf->Ln();
...
foreach ($matieres as $matiere) {
    ...
    $pdf->Cell(70, 8, utf8_decode($nom_matiere), 1);
    $pdf->Cell(40, 8, $moy, 1);
    $pdf->Cell(60, 8, utf8_decode($ment), 1);
    $pdf->Ln();
}


if ($valid_materials == count($matieres) && $valid_materials > 0) {
    $moy_gen = round($total / $valid_materials, 2);
    $pdf->Ln(5);
    ...
    $pdf->Cell(0, 8, "Mention Generale : -", 0, 1);
